...
create table "orders" ("customer" varchar(32), "department" varchar(32), "product" varchar(32), "quantity" integer, "created" timestamp default {ts '1970-01-01 00:00:00'})
create table "xmltypetest" ("id" varchar(32), "content" XMLTYPE)
insert into "xmltypetest" ("id","content") values ('id-123', new XMLType('<root>test</root>') )
